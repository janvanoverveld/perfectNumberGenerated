import {s5_Start,s5_End,executeProtocol, messages} from './s5';
import {BYE,CALC,RESULT} from './Message';
import {getSumOfDivisors} from './getSumOfDivisors';
//import * as fs from 'fs';

//const tempLOGFOLDER = "./log/";
//var logger     = fs.createWriteStream( tempLOGFOLDER + 'startS5runtimeLog.txt', { flags: 'w' });
...
async function protocol(s1:s5_Start):Promise<s5_End> {
   //logTime(`A`);
   let resolver:((s5_End)=>void)|null=null;
